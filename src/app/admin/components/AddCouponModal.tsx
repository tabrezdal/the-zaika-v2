...
export function AddCouponModal({ isOpen, onClose, onSubmit }: AddCouponModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
            <div>
              ...
              <div className="text-sm text-gray-500">Make this coupon available for use immediately</div>
            </div>
            <input
              type="checkbox"
