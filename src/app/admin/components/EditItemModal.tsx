  ...
  useEffect(() => {
    if (item) {
      setFormData({
        ...
        spiceLevel: (item as any).spiceLevel || "Medium"
      });
    }
  }, [item]);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-orange-500 transition-colors">
              {formData.coverImage && (
                <img src={formData.coverImage} alt="Preview" className="w-32 h-32 object-cover rounded-lg mx-auto mb-3" />
              )}
